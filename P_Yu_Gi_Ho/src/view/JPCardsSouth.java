...
public class JPCardsSouth extends JPanel{
	
	private static final String NAME_PLAYER = "Hand player 2: Juan";
	...
	public JPCardsSouth(Controller controller) {
	...
	private void init() {
		...
		this.setBackground(Color.decode("#093646"));
